...
use Ophim\ThemeRrdyw\Controllers\ThemeRrdywController;
...
Route::group([
    ...
    Route::post(sprintf('/%s/{movie}/{episode}/report', config('ophim.routes.movie', 'phim')), [ThemeRrdywController::class, 'reportEpisode'])->name('episodes.report');
    Route::post(sprintf('/%s/{movie}/rate', config('ophim.routes.movie', 'phim')), [ThemeRrdywController::class, 'rateMovie'])->name('movie.rating');
